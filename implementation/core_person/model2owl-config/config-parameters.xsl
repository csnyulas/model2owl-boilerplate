...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="base-ontology-uri" select="'http://data.europa.eu/m8g/ontology'"/>
    ...
    <!--    dct:title -->
    <xsl:variable name="ontologyTitle" select="'Core Person Vocabulary'"/>
    <!--    dct:description-->
    ...
    <!--    owl:priorVersion -->
    <xsl:variable name="priorVersion" select="'2.0.0'"/>
    <!--    vann:preferredNamespaceUri -->
    <xsl:variable name="preferredNamespaceUri" select="'http://data.europa.eu/m8g/ontology#'"/>
    <!--    vann:preferredNamespacePrefix -->
    <xsl:variable name="preferredNamespacePrefix" select="'cpv'"/>
